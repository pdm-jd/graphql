defmodule GraphQL.Lang.AST.CompositeVisitorTest do
  ...
  test "Composed Visitors are called in the correct order" do
    ...
    assert calls == [
             "v1 entering Document",
             "v2 entering Document",
             "v3 entering Document",
             "v1 entering ObjectTypeDefinition",
             "v2 entering ObjectTypeDefinition",
             "v3 entering ObjectTypeDefinition",
             "v1 entering Name",
             "v2 entering Name",
             "v3 entering Name",
             "v3 leaving Name",
             "v2 leaving Name",
             "v1 leaving Name",
             "v1 entering FieldDefinition",
             "v2 entering FieldDefinition",
             ...
             "v2 leaving Name",
             "v1 leaving Name",
             "v1 entering NamedType",
             "v2 entering NamedType",
             "v3 entering NamedType",
             "v1 entering Name",
             "v2 entering Name",
             "v3 entering Name",
             "v3 leaving Name",
             "v2 leaving Name",
             "v1 leaving Name",
             "v3 leaving NamedType",
             "v2 leaving NamedType",
             "v1 leaving NamedType",
             "v3 leaving FieldDefinition",
             "v2 leaving FieldDefinition",
             "v1 leaving FieldDefinition",
             "v3 leaving ObjectTypeDefinition",
             "v2 leaving ObjectTypeDefinition",
             "v1 leaving ObjectTypeDefinition",
             "v3 leaving Document",
             "v2 leaving Document",
             "v1 leaving Document"
           ]
