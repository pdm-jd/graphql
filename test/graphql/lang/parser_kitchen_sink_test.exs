        ...
        definitions: [
          %{
            ...
            selectionSet: %{
              ...
              selections: [
                %{
                  alias: %{kind: :Name, loc: %{start: 0}, value: "whoever123is"},
                  arguments: [
                    %{
                      kind: :Argument,
                      loc: %{start: 0},
                      ...
                      value: %{
                        ...
                        loc: %{start: 0},
                        values: [
                          %{kind: :IntValue, loc: %{start: 0}, value: 123},
                      ...
                      %{
                        directives: [
                          %{
                            kind: :Directive,
                            loc: %{start: 0},
                            name: %{kind: :Name, loc: %{start: 0}, value: "defer"}
                          }
                        ],
                        kind: :InlineFragment,
                        loc: %{start: 0},
                        selectionSet: %{
                          ...
                          selections: [
                            %{
                              kind: :Field,
                              loc: %{start: 0},
                              name: %{kind: :Name, loc: %{start: 0}, value: "field2"},
                              selectionSet: %{
                                kind: :SelectionSet,
                                loc: %{start: 0},
                                selections: [
                                  ...
                                  %{
                                    ...
                                    arguments: [
                                      %{
                                        kind: :Argument,
                                        loc: %{start: 0},
                                        name: %{kind: :Name, loc: %{start: 0}, value: "first"},
                                        value: %{kind: :IntValue, loc: %{start: 0}, value: 10}
                                      },
                                      %{
                                        kind: :Argument,
                                        loc: %{start: 0},
                                        name: %{kind: :Name, loc: %{start: 0}, value: "after"},
                                        value: %{
                                          kind: :Variable,
                                          loc: %{start: 0},
                                    ...
                                    kind: :Field,
                                    loc: %{start: 0},
                                    name: %{kind: :Name, loc: %{start: 0}, value: "field1"},
                                    selectionSet: %{
                                      kind: :SelectionSet,
                                      loc: %{start: 0},
                                      selections: [
            ...
            variableDefinitions: [
              %{
                ...
                type: %{
                  kind: :NamedType,
                  loc: %{start: 0},
                  name: %{kind: :Name, loc: %{start: 0}, value: "ComplexType"}
                },
                variable: %{
                  kind: :Variable,
                  loc: %{start: 0},
                ...
                %{
                  arguments: [
                    %{
                      kind: :Argument,
                      loc: %{start: 0},
                      name: %{kind: :Name, loc: %{start: 0}, value: "truthy"},
                      value: %{kind: :BooleanValue, loc: %{start: 0}, value: true}
                    },
                    %{
                      kind: :Argument,
                      loc: %{start: 0},
                      name: %{kind: :Name, loc: %{start: 0}, value: "falsey"},
